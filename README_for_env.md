...
- `SWISSEPH_DATA_PATH` (.env.example (line 15)): absolute or relative path where Swiss Ephemeris data files live (e.g. `/app/astro_data`); create the directory locally and mount the same path in containers.
